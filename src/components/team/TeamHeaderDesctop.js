    ...
    <div className="header-flex">
      ...
      <div className="header-right">
        <ul className="header-right-list">
          <li className="header-right-item"><Link to="/team" className="header-right-link header-right-link_dark active">Company</Link></li>
          ...
          <li className="header-right-item">
            <Link to="/team#contact" className="header-right-btn header-right-btn_blue">
