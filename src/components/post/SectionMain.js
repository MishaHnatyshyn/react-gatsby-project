...
export default () => (
  <section className="section inner">
    <div className="container">
      <img src="../img/inner.jpg" alt="" className="inner-img img-responsive" />
        <h2 className="inner-title">Featured Post Title</h2>
        <h4 className="inner-subtitle">What looked like a small patch of purple grass, above five feet square, was moving across the sand in their direction.</h4>
